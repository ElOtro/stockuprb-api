...
RSpec.describe "/v1/units", type: :request do
  ...
  describe "GET /index" do
    ...
    it "renders a successful response" do
      ...
      get v1_units_url, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested unit" do
      unit = Unit.create! valid_attributes
      expect {
        delete v1_unit_url(unit), headers: valid_headers, as: :json
      }.to change(Unit, :count).by(-1)
    end
  end
end
