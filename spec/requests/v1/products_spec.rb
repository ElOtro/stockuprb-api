...
RSpec.describe "/v1/products", type: :request do
  ...
  let(:valid_attributes) {
    attributes_for(:product, unit_id: unit.id, vat_rate_id: vat_rate.id )
  }
  ...
  describe "GET /index" do
    ...
    it "renders a successful response" do
      ...
      get v1_products_url, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested product" do
      product = Product.create! valid_attributes
      expect {
        delete v1_product_url(product), headers: valid_headers, as: :json
      }.to change(Product, :count).by(-1)
    end
  end
end
